...
public class QSTileView extends ViewGroup {
    public static final String TAG = "QSTileView";
    ...
    public View updateAccessibilityOrder(View previousView) {
        Log.d(TAG, "updateAccessibilityOrder: ");
        View firstView;
        View lastView;
        if (mDual) {
            lastView = mDualLabel;
